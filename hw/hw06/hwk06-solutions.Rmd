...
> As $p$ increases, the 90th percentile q90 does as well.  However, this is a jagged and not smooth line, since the binomial is discrete, so there are "jumps" between different integers.
...
> To find an area above, use subtraction or lower.tail = F. This is also the same as the probability in (a).

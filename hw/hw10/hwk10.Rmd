...
- Save the dataset as an object called `prob1`
- Print the dataset
...
Starting from `prob1`, count the total number of ads in the dataset, as well as the total number of "Funny" ads.  Build and interpret a 99% CI for $p_{funny}$, the overall proportion of funny ads across all of the brands.  Use the Agresti-Coull adjustment.
